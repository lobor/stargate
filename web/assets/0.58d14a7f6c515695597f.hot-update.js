		...
		_createClass(Login, [{
			...
			value: function render() {
				return _react2.default.createElement(
					_card.Card,
					{ style: { width: '350px', margin: 'auto' }, theme: theme },
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement('input', { name: 'name', id: 'name', ref: 'name', type: 'text', placeholder: 'Name' }),
								_react2.default.createElement('br', null),
								_react2.default.createElement('input', { name: 'password', id: 'password', ref: 'password', type: 'password', placeholder: 'Password' }),
								_react2.default.createElement('br', null),
